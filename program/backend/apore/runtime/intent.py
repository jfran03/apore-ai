...
_HELP_PATTERNS: tuple[re.Pattern[str], ...] = (
    ...
    re.compile(r"\ba hint\b", re.IGNORECASE),
    ...
    re.compile(r"\bexplain (this|that|it|how|what|why)\b", re.IGNORECASE),
    ...
    re.compile(r"\bi['']m lost\b", re.IGNORECASE),
    re.compile(r"\bi am lost\b", re.IGNORECASE),
    re.compile(r"\bi['']m confused\b", re.IGNORECASE),
    re.compile(r"\bi am confused\b", re.IGNORECASE),
    ...
    re.compile(r"\bwhere do i start\b", re.IGNORECASE),
    re.compile(r"\btutor mode\b", re.IGNORECASE),
